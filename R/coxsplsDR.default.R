...
else {return(list(tt_splsDR=tt_splsDR, cox_splsDR=cox_splsDR, splsDR_mod=splsDR_mod, splsDR_modplsr=splsDR_modplsr, XplanScal=XplanScal, XplanCent=XplanCent))}
}
